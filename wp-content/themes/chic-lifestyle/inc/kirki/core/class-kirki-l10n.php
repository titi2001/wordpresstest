...
class Kirki_L10n {
	 ...
	 * @var string
	 */
	private $textdomain = 'chic-lifestyle';
	...
	public function override_load_textdomain( $override, $domain, $mofile ) {
		...
		if ( isset( $l10n[ $this->get_theme_textdomain() ] ) ) {
			$l10n['chic-lifestyle'] = $l10n[ $this->get_theme_textdomain() ]; // phpcs:ignore WordPress.WP.GlobalVariablesOverride
		}

		// Check if the domain is "kirki".
		if ( 'chic-lifestyle' === $domain ) {
			return true;
		}
		return $override;
	}
