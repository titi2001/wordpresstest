...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args(
			$this->button_labels,
			array(
				'select'       => esc_html__( 'Select image', 'chic-lifestyle' ),
				'change'       => esc_html__( 'Change image', 'chic-lifestyle' ),
				'default'      => esc_html__( 'Default', 'chic-lifestyle' ),
				'remove'       => esc_html__( 'Remove', 'chic-lifestyle' ),
				'placeholder'  => esc_html__( 'No image selected', 'chic-lifestyle' ),
				'frame_title'  => esc_html__( 'Select image', 'chic-lifestyle' ),
				'frame_button' => esc_html__( 'Choose image', 'chic-lifestyle' ),
			)
		);
	}
