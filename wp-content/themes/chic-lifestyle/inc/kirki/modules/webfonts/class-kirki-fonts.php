...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_html__( 'Ultra-Light 100', 'chic-lifestyle' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'chic-lifestyle' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'chic-lifestyle' ),
			'200'       => esc_html__( 'Light 200', 'chic-lifestyle' ),
			'200italic' => esc_html__( 'Light 200 Italic', 'chic-lifestyle' ),
			'300'       => esc_html__( 'Book 300', 'chic-lifestyle' ),
			'300italic' => esc_html__( 'Book 300 Italic', 'chic-lifestyle' ),
			'400'       => esc_html__( 'Normal 400', 'chic-lifestyle' ),
			'regular'   => esc_html__( 'Normal 400', 'chic-lifestyle' ),
			'italic'    => esc_html__( 'Normal 400 Italic', 'chic-lifestyle' ),
			'500'       => esc_html__( 'Medium 500', 'chic-lifestyle' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'chic-lifestyle' ),
			'600'       => esc_html__( 'Semi-Bold 600', 'chic-lifestyle' ),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'chic-lifestyle' ),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'chic-lifestyle' ),
			'700'       => esc_html__( 'Bold 700', 'chic-lifestyle' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'chic-lifestyle' ),
			'800'       => esc_html__( 'Extra-Bold 800', 'chic-lifestyle' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'chic-lifestyle' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'chic-lifestyle' ),
			'900'       => esc_html__( 'Ultra-Bold 900', 'chic-lifestyle' ),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'chic-lifestyle' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'chic-lifestyle' ),
		);
	}
