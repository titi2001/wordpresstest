...
data.choices.labels = _.defaults( data.choices.labels, {
	select: '<?php esc_html_e( 'Select image', 'chic-lifestyle' ); ?>',
	change: '<?php esc_html_e( 'Change image', 'chic-lifestyle' ); ?>',
	'default': '<?php esc_html_e( 'Default', 'chic-lifestyle' ); ?>',
	remove: '<?php esc_html_e( 'Remove', 'chic-lifestyle' ); ?>',
	placeholder: '<?php esc_html_e( 'No image selected', 'chic-lifestyle' ); ?>',
	frame_title: '<?php esc_html_e( 'Select image', 'chic-lifestyle' ); ?>',
	frame_button: '<?php esc_html_e( 'Choose image', 'chic-lifestyle' ); ?>',
} );
#>
