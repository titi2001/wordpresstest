	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'       => esc_html__( 'No File Selected', 'chic-lifestyle' ),
				'remove'               => esc_html__( 'Remove', 'chic-lifestyle' ),
				'default'              => esc_html__( 'Default', 'chic-lifestyle' ),
				'selectFile'           => esc_html__( 'Select File', 'chic-lifestyle' ),
				'standardFonts'        => esc_html__( 'Standard Fonts', 'chic-lifestyle' ),
				'googleFonts'          => esc_html__( 'Google Fonts', 'chic-lifestyle' ),
				'defaultCSSValues'     => esc_html__( 'CSS Defaults', 'chic-lifestyle' ),
				'defaultBrowserFamily' => esc_html__( 'Default Browser Font-Family', 'chic-lifestyle' ),
			)
		);
