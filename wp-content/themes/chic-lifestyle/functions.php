...
if ( ! function_exists( 'clp_fs' ) ) {
    ...
    function clp_fs() {
        ...
        if ( ! isset( $clp_fs ) ) {
            ...
            $clp_fs = fs_dynamic_init( array(
                'id'                  => '6394',
                'slug'                => 'chic-lifestyle',
                'premium_slug'        => 'chic-lifestyle-pro',
                'type'                => 'theme',
                'public_key'          => 'pk_41de92096a076c4b1e1ba198fbcb7',
                'is_premium'          => false,
                'premium_suffix'      => 'pro',
                ...
                'secret_key'          => 'sk_p^LBf0yc7a}o80MiTQ-wPKPZg{iFg',
            ) );
        }
